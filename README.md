...
inset: 0;
background:
radial-gradient(ellipse at 20% 60%, rgba(42,101,128,0.2) 0%, transparent 60%),
radial-gradient(ellipse at 80% 40%, rgba(201,147,58,0.15) 0%, transparent 50%),
linear-gradient(160deg, #c8e6f0 0%, #dff0f8 50%, #fdf5e0 100%);
}
...
text-shadow: 0 4px 20px rgba(42,101,128,0.15);
}
